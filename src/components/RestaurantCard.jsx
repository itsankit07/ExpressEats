...
const RestaurantCard = (props) =>{
    ...
    return (
        <div className='tracking-tight w-[330px] h-[320px] group-hover:scale-95 transition-transform'>
            ...
            <h3 className='mt-4 text-lg md:text-lg font-GrotBold text-customBlack-1'>{truncateName(name)}</h3>
...
export const RestaurantCardOffer = ()=>{
  return (props) =>{
    const {resInfo} = props;
    ...
    return (
      ...
      {isOpen && (
        <>
         ...
         <div className='font-ProximaNovaBold  text-white/95 text-[22px] absolute bottom-[108px] left-4 group-hover:scale-95 transition-transform resoffer'>
